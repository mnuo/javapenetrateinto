 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://distributedjava.mnuocom.com/distributedjava1/webservice/client", wsdlLocation = "http://localhost:9527/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://distributedjava.mnuocom.com/distributedjava1/webservice/client", "BusinessService");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://distributedjava.mnuocom.com/distributedjava1/webservice/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://distributedjava.mnuocom.com/distributedjava1/webservice/client", "BusinessPort"), Business.class, features);
    }
